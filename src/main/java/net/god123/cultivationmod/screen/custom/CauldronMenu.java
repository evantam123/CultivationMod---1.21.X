package net.god123.cultivationmod.screen.custom;
...
public class CauldronMenu extends AbstractContainerMenu {
    ...
    public CauldronMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CAULDRON_MENU.get(), pContainerId);
        this.blockEntity = ((CauldronBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CAULDRON_BLOCK.get());
    }
